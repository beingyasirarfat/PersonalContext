...
// 	if (clickData.menuItemId == "PersoanlContext" && clickData.selectionText && ! clickData.altKey) {
...
// 						if (data.sound == 'on') {
// 							readOutLoud(clickData.selectionText);
// 						}
// 					}
// 				};
...
// 				xhttp.send(word);
// 			} else {
// 				//on shift + click save task


// 				if (clickData.shiftKey) {
// 					chrome.storage.sync.get("Tasks", function (data) {
// 						let obj = data.Tasks;
// 						if (!obj) obj = new Array();
// 						obj.push({ Task: clickData.selectionText, done: false, time: Date.now() });
// 						chrome.storage.sync.set({ 'Tasks': obj }, () => renderTable(obj));
// 						chrome.storage.sync.get({ Words: [], 'sound': 'on' }, function (data) {
// 							if (data.sound == 'on') {
// 								readOutLoud(clickData.selectionText + " added to your tasks");
// 							}
// 						});
// 					}
// 					);
