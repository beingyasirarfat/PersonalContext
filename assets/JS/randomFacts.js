const facts = [
	...
	"In total our Indian hockey team has won eight Olympics gold medals. (1928 to 1956 - remained unbeaten in the Olympics)",
	...
	"India hosted the Asian Games for the first time on March 4 1951 and it was held in New Delhi.",
	...
	"Indian national football team qualified for the 1950 World Cup finals in Brazil but could not appear as they still played bare feet at the time.",
	...
	"International Business Machines is the expansion of 'IBM'.",
	...
	"It is impossible to lick your elbow. (know you gonna try this...)",
	"It is now possible to print human skin with an inkjet printer!",
	"It is physically impossible for pigs to look up into the sky while they are standing.",
	...
	"Italy is only country in FIFA world cup for the most matches with draw. (21 matches)",
	...
	"Jack Dorsey Evan Williams Biz Stone worked as a team and founded 'Twitter'. It was launched on July 15 200",
	"Jack is the most common name in nursery rhymes",
	"Jackie chan's real name is 'Chan Kong-sang' and was born on 7-April-1954 in Hong Kong.",
	...
	"Japan surrendered to USA on September 2 1945 (After Hiroshima & Nagasaki atomic bomb blasts)",
	...
	"Kamal Hassan holds the record for the most National Film Awards for an actor with four three awards for Best Actor and one for Best Child Artiste.",
	...
	"King Fahd International Airport in Damman Saudi Arabia is one of the world's biggest airport with 780 square kilometres (larger than the nearby country of Bahrain).",
	...
	"Kumar Ram Narain Karthikeyan was born on Jan 14 197",
	"Kushang Sherpa (now an instructor with Himlayan Mountaineering Institute) is the only climber to climb all 4 sides of Mt. Everest.",
	...
	"Lever Brothers India Limited was formed in 1933 and then renamed to “Hindustan Unilever Limited” in June 200",
	...
	"Lizards use their tongues as sense organs. Lizards never stop growing.",
	...
	"Mahatma Gandhi was assassinated on 30 January 1948 shot at point-blank range by Nathuram Godse. (Succeeded on fifth attempt)",
	...
	"Mathematical signs fact: 12+3-4+5+67+8+9100",
	...
	"Mercedes Benz company was founded in 1881 by 'Gottlieb Daimler' and 'Karl Benz'.",
	...
	"Mexico holds the record for most number of FIFA match loss. (22 matches)",
	"Michael Jordan makes more money from Nike annually than all of the Nike factory workers in Malaysia combined.",
	"Michael Jordan was cut from his high school basketball team his sophomore year.",
	"Michael Joseph Jackson was born on August 29 1958 and died on June 25 200",
	...
	"Mohandas Karamchand Gandhi'ji born on 2nd october 186",
	...
	"Moths are not really attracted to light it fly towards the blackest point which is behind the light.",
	...
	"Mozilla Firefox was originally created by Dave Hyatt and Blake Ross as part of an experimental project.",
	...
	"Muralidharan's wickets list. Craig McDermott (1st) Stephen Fleming (100) Ben Hollioake (200) Shaun Pollock (300) Henry Olonga(400) Michael Kasprowicz (500) Khaled Mashud (600) Syed Rasel (700) Pragyan Ojha (800).",
	...
	"Oleg Salenko (Russia) has scored 5 goals in one match against Cameroon in 199",
	...
	"On average women say 7000 words per day. Men manage just over 200",
	...
	"On January 27 2010 Sun Microsystems was acquired by Oracle Corporation for US$4 billion",
	"On July 20 1969 Commander Neil Armstrong became the first man to step in the moon.",
	...
	"One barrel of petroleum holds 42 gallons (159 liters).",
	...
	"One% of Greenland's population lives in a single apartment building!",
	...
	"Only 4 out of 20000 species of bees produce honey.",
	...
	"Only four players are allowed as a substitute in a single football match.",
	...
	"Orkut Buyukkokten (a Turkish software engineer) is the creator of Orkut.",
	...
	"Our Indian flag was designed by \"Pingali Venkayya\"and it became our official flag on '22 July 1947'.",
	"Our normal body temperature is 37°C (99°F).",
	...
	"Over 98% of Japanese people are cremated after they die.",
	...
	"Peregrine Falcons(they knock out its prey in a downward dive over 270 mph) Cheetah (70 mph) and Sailfish (70 mph) are the most fastest creatures in the world.",
	...
	"Place a mirror in the water bowl (mirror has to be partly in the water). Now place it in the sunlight and see the reflection in wall. You can easily produce rainbow in your room. ",
	...
	"Rabbit and the parrot can see behind itself without turning its head.",
	"rabbits like licorice",
	"Rabindranath Tagore (Bengali) was born on 7 May 1861 and died on 7 August 194",
	...
	"Rajiv Gandhi was born on August 20 194",
	"Rajiv Nayyar (India) batted for 16 hr 55 min when scoring 271 for Himachal Pradesh v Jammu & Kashmir at Chamba from 1 to 3 Nov 1999 A World record for longest innings.",
	...
	"Real name of Charlie Chaplin is 'Charles Spencer Chaplin' and was born on 16 April 188",
	"Real name of Sonia Gandhi is 'Edvige Antonia Albina Maino'.",
	'Record for fastest goal in a Fifa World Cup is "189 seconds"by Hakan Sükür ( Turkey) vs Korea Republic June 29 200',
	...
	"Robert Browning (English poet) born on 07 May 1812 (today).",
	"Robert Wadlow 8 ft 11 in (272 cm) confirmed tallest male and person by Guinness World Records. (Lifespan: 1918 to 1940)",
	...
	"Sachin Tendulkar is the first batsman declared run out by a third umpire decision in the history of cricket.",
	...
	"Seagate introduced the first hdd for pcs in 197It held 5 M.B of data.",
	...
	"Sir Isaac Newton became the Member of Parliament in the year 1689 and continued till the next year.",
	"Sir Isaac Newton was 23 when he discovered the law of gravity",
	"Sir Isaac Newton was 23 when he discovered the law of gravity.",
	"Size of Football goal post is 32m length and 44m in width",
	...
	"Snakes & Ladders one of the most widely played board games was created by the 13th century poet Saint Gyandev (India).",
	...
	"Sun network was established in Apr 14 1993 and has over 20 television channels in four languages now.",
	"Sunlight travels at a speed of 299792 Km/sec to reach the earth.",
	"Surgeons who listen to music during operations perform better than those who don't .",
	"Surprisingly an average little mosquito has 47 teeth.",
	...
	'Tamil actress Manorama\'s first tamil film is "Maalayitta Mangai"released in 195',
	"Tapeworms range in size from about 04 inch to more than 50 feet in length.",
	...
	"Television was invented by group of members 'John Logie Baird' 'Philo T. Farnsworth' and 'Vladimir Zworykin'.",
	...
	"The 'AK-47' (Avtomat Kalashnikova gun) first developed in the Soviet Union by Mikhail Kalashnikov.",
	...
	"The 'Wings of fire'(An Autobiography of APJ Abdul Kalam) was written by Mr.Abdul Kalam and Mr. Arun Tiwari.",
	...
	"the average ice berg weighs 20,000,000 tons",
	"The average lead pencil can draw a line that is almost 35 miles long or you can write almost 50000 words in English.",
	...
	"The average lifespan of a cow is 7 years. The oldest cow ever recorded was Big Bertha. She reached 48 in 199",
	...
	"The average red blood cell in our body lives for 120 days.",
	...
	"The biggest clouds are 'Cumulonimbus' climbing up to 7 kilometers (6 miles) high and holding up to half a million tons of water.",
	...
	"The Boeing-757 has carried more than 3 billion passengers.",
	...
	"The current world record holder of the 100m sprint race is Usain BOLT from Jamaica. (72 sec)",
	"the D.C. in Washington D.C. stands for District of Columbia",
	"The D/L method (used in Cricket) was devised by two English statisticians Frank Duckworth and Tony Lewis.",
	"The Dallas/Ft. Worth airport is larger than New York City's Manhattan Island.",
	"The Dead Sea is actually an inland lake",
	"The deepest mine in the world is the East Rand mine which goes to a depth of about 3585 metres.",
	...
	"The egg of the hummingbird is the world's smallest bird's egg",
	"the egg of the ostrich the world's largest.",
	...
	"The first bowler to take 10 wickets in a Test innings was Jim Laker in 195",
	...
	"The first coast-to-coast telephone line was established in 191",
	...
	"The first OSCAR awards were presented on May 16 1929 at the Hollywood Roosevelt Hotel with an audience of about 26 people.",
	...
	"The first railway line in india was opened to traffic between 'Mumbai and Thane' (Maharashtra).",
	...
	"The First Wireless TV Remote was invented by 'Eugene Polley' in 195",
	...
	"The highest attendance for one football match was in the 1950 final. The official attendance was 199854 for the match between Brazil and Uruguay.",
	"The highest point in Pennsylvania is lower than the lowest point in Colorado!",
	"The highest speed ever achieved on a bicycle is 26831 kmph (1694mph) by Fred Rompelberg. (Record date: 3 October 1995)",
	...
	"The human body contains 96000km(59650miles) of blood vessels.",
	...
	"The Indian economy is the world's eleventh largest economy by nominal GDP and the fourth largest by purchasing power parity.",
	...
	"The Knock Nevis was a massive ship with '1504' ft length last used as a floating storage and offloading unit (FSO)",
	...
	"The largest recorded tsunami was a wave 1720 feet (524 meters) above sea level in Lituya Bay Alaska (July 9 1958)",
	...
	"The longest professional tennis match was between Nicolas Mahut and John Isner on June 22 23 and 24 2010. It lasted 183 games and required 11 hours and 5 minutes of playing time.",
	...
	"The longest tournament chess game (in terms of moves) ever to be played was Nikolic - Arsovic Belgrade 1989 which lasted for 269 moves and took 20 hours and 15 minutes to complete a drawn game.",
	...
	"The Lucky Dog (1921) is the first film to include both members 'Stan Laurel' and 'Oliver Hardy' later known as Laurel and Hardy.",
	...
	"The most poisonous lizard is 'Gila monster'.",
	...
	"The only confirmed poisonous bird in the world is 'Hooded Pitohui' of Papua New Guinea. The poison is found in its skin and feathers.",
	"the only continent with no active volcanoes is Australia",
	"the only continent without reptiles or snakes is Antarctica",
	"The only country in the world with 13 months is Ethiopia.",
	"The only fish which can able to fly is Exocoetidae.",
	...
	"The race number 46 has been ever present in Valentino Rossi's career uses same number as his father Graziano ran with during his own Moto GP career.",
	...
	"The scientific name for the domestic dog is 'Canis lupis familiaris'.",
	"The scientific name of human being's is HOMO SAPIENS.",
	"The Scientifical name of 'Tiger' is 'Panthera tigris'.",
	...
	"The song 'Mile Sur Mera Tumhara' was composed by Ashok Patki and written by Piyush Pandey and was telecast for the first time on Independence Day 1988 in Doordarshan.",
	"The song 'Strawberry Fields Forever', sung by the Beatles, refers to an orphanage located in Liverpool.",
	"The sound made by a 'Deer' is called 'Bell'.",
	"The sound made by a 'Elephant' is called 'Trumpet'.",
	"The sound made by a 'Lion' is called 'Roar'.",
	"The sound made by a 'Peacock' is called 'Scream'.",
	"The sound made by a 'Snake' is called 'Hiss'.",
	"The speed of a typical raindrop is 17 miles per hour.",
	"The speed of sound in water is 1435 m/sec - nearly five times faster than the speed of sound in air.",
	...
	"The Summy Company registered 'Happy Birthday to You' song for copyright in 1935 crediting authors Preston Ware Orem and Mrs. R.R. Forman.",
	...
	"The two planes crashed in Twin towers are \"Q33 NY (Flight 11)\"and 'Flight 77'.(More interesting Type \"Q33 NY\"in Ms-Word with font size 48 and font name as 'WINGDINGS'and hit 'Enter' key).",
	...
	"The U.N.O headquarters is located at Geneva.",
	...
	"The very first motorcycle was made by Sylvester Howard roper in 186",
	"the vocabulary of the average person is between 5,000 to 6,000 words",
	"The volume of the Earth's moon is the same as the volume of the Pacific Ocean.",
	"The wandering albatross is the bird with the biggest wingspan reaching up to 3 metres and weigh between 6 and 16 kg.",
	...
	"The world's biggest library is the Library of Congress the national library of the United States.",
	...
	"The world's highest cricket ground is in Chail Himachal Pradesh located at an altitude of 7500 feet above sea-level.",
	...
	"The youngest person to climb Mount Everest was 13-year-old Jordan Romero in 22' May 201",
	...
	"There are 102 floors in Empire State building New York City.",
	...
	"There are currently 6912 living languages defined as languages that people speak today.",
	...
	"There are roughly 144000 mosquitoes for every person on earth.",
	"There are some species of snails that are extremely venomous.",
	"There are three golf balls sitting on the moon.",
	"There are two independent states within Italy: the Republic of San Marino (25 square miles) and the Vatican City (just 107 acres)",
	"There are two kinds of camels 'Arabian' with one humps (lives in Western Asia and Northern Africa) and 'Bactrian' with two humps (lives in Mongolia and Chinese Turkistan.)",
	...
	"Tim Berners-Lee is the founder & director of the World Wide Web Consortium (W3C).",
	...
	"Uawa FM (New Zealand 8-July-2010 175-hours) radio jockey Nikora Curtis broke the world record of RJ Dheena's (Big FM) 168 hours program.",
	...
	'V.N. Sudhakaran and N. Sathyalakshmi couple holds the world record for "Biggest Wedding Banquet (15-sep-1995)"with over 150000 guests.',
	...
	'Viswanathan Anand won "Chess Oscar"award 5 times. (1997 1998 2003 2004 2007)',
	...
	"When water gets cool enough molecular movement is slowed enough that the molecules stick to each other and form ice crystals.",
	...
	"William Morgan invented volleyball in 189",
	"William Shakespeare born on 26 April 1564 and died 23 April 161",
	...
	"World record for longest nails is by 'Shridhar Chillal' Pune – Maharashtra.",
	"World War II was lasting from 1939 to 194",
	"World's highest MegaPixel camera is invented by David Bergman with 1474 megapixels.",
	"World's most expensive budget film: \"Pirates of the Caribbean: At World's End\"- Released: 5/25/2007",
	"World's shortest man: Khagendra Thapa Magar from Nepal stands at 22 inches (56 cm) tall according to Guinness World Records. (born 1991).",
	"World’s heaviest primates:  morbidly obese humans. After that: gorillas at 485 lbs.",
	'World’s Largest Film Studio is "Ramoji Film City" Hyderabad.',
	...
	"Yahoo! was founded by Jerry Yang and David Filo in January 1994 and was incorporated on March 1 199",
